...
abstract class Type implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelSample\\Map\\TypeTableMap';
    ...
    /**
     * Initializes internal state of PropelSample\Base\Type object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PropelSample\Type The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PropelSample\\Type'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->customersScheduledForDeletion !== null) {
                if (!$this->customersScheduledForDeletion->isEmpty()) {
                    \PropelSample\CustomerQuery::create()
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelSample\Type The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelSample\Type (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelSample\Type Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCustomers($overrideExisting = true)
    {
        ...
        $this->collCustomers->setModel('\PropelSample\Customer');
    }
