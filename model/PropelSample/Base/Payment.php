...
abstract class Payment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelSample\\Map\\PaymentTableMap';
    ...
    /**
     * Initializes internal state of PropelSample\Base\Payment object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PropelSample\Payment The current object (for fluent API support)
     */
    ...
    public function setIdentifier($v)
    {
        ...
        if ($this->identifier !== $v) {
            $this->identifier = $v;
            $this->modifiedColumns[PaymentTableMap::COL_IDENTIFIER] = true;
        }
    ...
    public function setBankName($v)
    {
        ...
        if ($this->bank_name !== $v) {
            $this->bank_name = $v;
            $this->modifiedColumns[PaymentTableMap::COL_BANK_NAME] = true;
        }
    ...
    public function setDetails($v)
    {
        ...
        if ($this->details !== $v) {
            $this->details = $v;
            $this->modifiedColumns[PaymentTableMap::COL_DETAILS] = true;
        }
    ...
    public function setContractId($v)
    {
        ...
        if ($this->contract_id !== $v) {
            $this->contract_id = $v;
            $this->modifiedColumns[PaymentTableMap::COL_CONTRACT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentTableMap::translateFieldName('Identifier', TableMap::TYPE_PHPNAME, $indexType)];
            $this->identifier = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PaymentTableMap::translateFieldName('BankName', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PaymentTableMap::translateFieldName('Details', TableMap::TYPE_PHPNAME, $indexType)];
            $this->details = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PaymentTableMap::translateFieldName('ContractId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PropelSample\\Payment'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PaymentTableMap::COL_IDENTIFIER)) {
            $modifiedColumns[':p' . $index++]  = '`identifier`';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_BANK_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`bank_name`';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`amount`';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DETAILS)) {
            $modifiedColumns[':p' . $index++]  = '`details`';
        }
        if ($this->isColumnModified(PaymentTableMap::COL_CONTRACT_ID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PropelSample\Payment
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelSample\Payment The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentTableMap::COL_IDENTIFIER)) {
            $criteria->add(PaymentTableMap::COL_IDENTIFIER, $this->identifier);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_BANK_NAME)) {
            $criteria->add(PaymentTableMap::COL_BANK_NAME, $this->bank_name);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_AMOUNT)) {
            $criteria->add(PaymentTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_DETAILS)) {
            $criteria->add(PaymentTableMap::COL_DETAILS, $this->details);
        }
        if ($this->isColumnModified(PaymentTableMap::COL_CONTRACT_ID)) {
            $criteria->add(PaymentTableMap::COL_CONTRACT_ID, $this->contract_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelSample\Payment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelSample\Payment Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aContract === null && ($this->contract_id != 0)) {
    ...
    {
        if (null !== $this->aContract) {
            $this->aContract->removePayment($this);
        }
        $this->id = null;
