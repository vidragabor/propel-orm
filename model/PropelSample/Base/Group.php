...
abstract class Group implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelSample\\Map\\GroupTableMap';
    ...
    /**
     * Initializes internal state of PropelSample\Base\Group object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PropelSample\Group The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PropelSample\\Group'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PropelSample\Group
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelSample\Group The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelSample\Group (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelSample\Group Clone of current object.
     * @throws PropelException
     */
