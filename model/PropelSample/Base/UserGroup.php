...
use \Exception;
use \PDO;
use PropelSample\Group as ChildGroup;
use PropelSample\GroupQuery as ChildGroupQuery;
...
abstract class UserGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelSample\\Map\\UserGroupTableMap';
    ...
    /**
     * Initializes internal state of PropelSample\Base\UserGroup object.
     */
     ...
     * @return $this|\PropelSample\UserGroup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserGroupTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserGroupTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PropelSample\\UserGroup'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PropelSample\UserGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelSample\UserGroup The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelSample\UserGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelSample\UserGroup Clone of current object.
     * @throws PropelException
     */
