...
use \Exception;
use \PDO;
use PropelSample\Type as ChildType;
use PropelSample\TypeQuery as ChildTypeQuery;
use PropelSample\Map\TypeTableMap;
 ...
 *
 * @method     ChildTypeQuery leftJoinCustomer($relationAlias = null) Adds a LEFT JOIN clause to the query using the Customer relation
 * @method     ChildTypeQuery rightJoinCustomer($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Customer relation
 * @method     ChildTypeQuery innerJoinCustomer($relationAlias = null) Adds a INNER JOIN clause to the query using the Customer relation
 *
 * @method     ChildTypeQuery joinWithCustomer($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Customer relation
 *
 * @method     ChildTypeQuery leftJoinWithCustomer() Adds a LEFT JOIN clause and with to the query using the Customer relation
 * @method     ChildTypeQuery rightJoinWithCustomer() Adds a RIGHT JOIN clause and with to the query using the Customer relation
 * @method     ChildTypeQuery innerJoinWithCustomer() Adds a INNER JOIN clause and with to the query using the Customer relation
 *
 * @method     \PropelSample\CustomerQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class TypeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PropelSample\Base\TypeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PropelSample\\Type', $modelAlias = null)
    {
     ...
     *
     * @param \PropelSample\Customer|ObjectCollection $customer the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByCustomer($customer, $comparison = null)
    {
        if ($customer instanceof \PropelSample\Customer) {
            return $this
                ->addUsingAlias(TypeTableMap::COL_ID, $customer->getTypeId(), $comparison);
