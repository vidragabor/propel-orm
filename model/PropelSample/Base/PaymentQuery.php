 ...
 * @method     ChildPaymentQuery orderByIdentifier($order = Criteria::ASC) Order by the identifier column
 * @method     ChildPaymentQuery orderByBankName($order = Criteria::ASC) Order by the bank_name column
 * @method     ChildPaymentQuery orderByAmount($order = Criteria::ASC) Order by the amount column
 * @method     ChildPaymentQuery orderByDetails($order = Criteria::ASC) Order by the details column
 * @method     ChildPaymentQuery orderByContractId($order = Criteria::ASC) Order by the contract_id column
 *
 * @method     ChildPaymentQuery groupById() Group by the id column
 * @method     ChildPaymentQuery groupByIdentifier() Group by the identifier column
 * @method     ChildPaymentQuery groupByBankName() Group by the bank_name column
 * @method     ChildPaymentQuery groupByAmount() Group by the amount column
 * @method     ChildPaymentQuery groupByDetails() Group by the details column
 * @method     ChildPaymentQuery groupByContractId() Group by the contract_id column
 *
 ...
 *
 * @method     ChildPaymentQuery leftJoinContract($relationAlias = null) Adds a LEFT JOIN clause to the query using the Contract relation
 * @method     ChildPaymentQuery rightJoinContract($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Contract relation
 * @method     ChildPaymentQuery innerJoinContract($relationAlias = null) Adds a INNER JOIN clause to the query using the Contract relation
 *
 * @method     ChildPaymentQuery joinWithContract($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Contract relation
 *
 * @method     ChildPaymentQuery leftJoinWithContract() Adds a LEFT JOIN clause and with to the query using the Contract relation
 * @method     ChildPaymentQuery rightJoinWithContract() Adds a RIGHT JOIN clause and with to the query using the Contract relation
 * @method     ChildPaymentQuery innerJoinWithContract() Adds a INNER JOIN clause and with to the query using the Contract relation
 *
 * @method     \PropelSample\ContractQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPayment findOneByIdentifier(string $identifier) Return the first ChildPayment filtered by the identifier column
 * @method     ChildPayment findOneByBankName(string $bank_name) Return the first ChildPayment filtered by the bank_name column
 * @method     ChildPayment findOneByAmount(string $amount) Return the first ChildPayment filtered by the amount column
 * @method     ChildPayment findOneByDetails(string $details) Return the first ChildPayment filtered by the details column
 * @method     ChildPayment findOneByContractId(int $contract_id) Return the first ChildPayment filtered by the contract_id column *
 ...
 * @method     ChildPayment requireOneByIdentifier(string $identifier) Return the first ChildPayment filtered by the identifier column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPayment requireOneByBankName(string $bank_name) Return the first ChildPayment filtered by the bank_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPayment requireOneByDetails(string $details) Return the first ChildPayment filtered by the details column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPayment requireOneByContractId(int $contract_id) Return the first ChildPayment filtered by the contract_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPayment[]|ObjectCollection findByIdentifier(string $identifier) Return ChildPayment objects filtered by the identifier column
 * @method     ChildPayment[]|ObjectCollection findByBankName(string $bank_name) Return ChildPayment objects filtered by the bank_name column
 ...
 * @method     ChildPayment[]|ObjectCollection findByDetails(string $details) Return ChildPayment objects filtered by the details column
 * @method     ChildPayment[]|ObjectCollection findByContractId(int $contract_id) Return ChildPayment objects filtered by the contract_id column
...
abstract class PaymentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PropelSample\Base\PaymentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PropelSample\\Payment', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `identifier`, `bank_name`, `amount`, `details`, `contract_id` FROM `payment` WHERE `id` = :p0';
        try {
    ...
    public function filterByIdentifier($identifier = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaymentTableMap::COL_IDENTIFIER, $identifier, $comparison);
    }
    ...
    public function filterByBankName($bankName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaymentTableMap::COL_BANK_NAME, $bankName, $comparison);
    }
    ...
    public function filterByDetails($details = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaymentTableMap::COL_DETAILS, $details, $comparison);
    }
    ...
    public function filterByContractId($contractId = null, $comparison = null)
    {
        if (is_array($contractId)) {
            ...
            if (isset($contractId['min'])) {
                $this->addUsingAlias(PaymentTableMap::COL_CONTRACT_ID, $contractId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($contractId['max'])) {
                $this->addUsingAlias(PaymentTableMap::COL_CONTRACT_ID, $contractId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PaymentTableMap::COL_CONTRACT_ID, $contractId, $comparison);
    }

    /**
     * Filter the query by a related \PropelSample\Contract object
     *
     * @param \PropelSample\Contract|ObjectCollection $contract The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByContract($contract, $comparison = null)
    {
        if ($contract instanceof \PropelSample\Contract) {
            return $this
                ->addUsingAlias(PaymentTableMap::COL_CONTRACT_ID, $contract->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PaymentTableMap::COL_CONTRACT_ID, $contract->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
