...
use PropelSample\Customer;
use PropelSample\CustomerQuery;
...
class CustomerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelSample.Map.CustomerTableMap';
     ...
     */
    const OM_CLASS = '\\PropelSample\\Customer';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelSample.Customer';
     ...
     */
    const COL_TYPE_ID = 'customer.type_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Address', 'TypeId', 'Active', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'address', 'typeId', 'active', ),
        self::TYPE_COLNAME       => array(CustomerTableMap::COL_ID, CustomerTableMap::COL_NAME, CustomerTableMap::COL_ADDRESS, CustomerTableMap::COL_TYPE_ID, CustomerTableMap::COL_ACTIVE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'address', 'type_id', 'active', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Address' => 2, 'TypeId' => 3, 'Active' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'address' => 2, 'typeId' => 3, 'active' => 4, ),
        self::TYPE_COLNAME       => array(CustomerTableMap::COL_ID => 0, CustomerTableMap::COL_NAME => 1, CustomerTableMap::COL_ADDRESS => 2, CustomerTableMap::COL_TYPE_ID => 3, CustomerTableMap::COL_ACTIVE => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'address' => 2, 'type_id' => 3, 'active' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelSample\\Customer');
        ...
        $this->addForeignKey('type_id', 'TypeId', 'INTEGER', 'type', 'id', true, null, null);
    ...
    {
        $this->addRelation('Type', '\\PropelSample\\Type', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':type_id',
    1 => ':id',
        ...
        $this->addRelation('Contract', '\\PropelSample\\Contract', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':customer_id',
    1 => ':id',
  ),
), null, null, 'Contracts', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CustomerTableMap::COL_TYPE_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelSample\Customer) { // it's a model object
