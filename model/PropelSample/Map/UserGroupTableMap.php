...
use PropelSample\UserGroup;
use PropelSample\UserGroupQuery;
...
class UserGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelSample.Map.UserGroupTableMap';
     ...
     */
    const OM_CLASS = '\\PropelSample\\UserGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelSample.UserGroup';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_CAMELNAME     => array('id', 'userId', 'groupId', ),
        self::TYPE_COLNAME       => array(UserGroupTableMap::COL_ID, UserGroupTableMap::COL_USER_ID, UserGroupTableMap::COL_GROUP_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_CAMELNAME     => array('id' => 0, 'userId' => 1, 'groupId' => 2, ),
        self::TYPE_COLNAME       => array(UserGroupTableMap::COL_ID => 0, UserGroupTableMap::COL_USER_ID => 1, UserGroupTableMap::COL_GROUP_ID => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelSample\\UserGroup');
    ...
    {
        $this->addRelation('User', '\\PropelSample\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
        ...
        $this->addRelation('Group', '\\PropelSample\\Group', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':group_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelSample\UserGroup) { // it's a model object
