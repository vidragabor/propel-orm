...
use PropelSample\Type;
use PropelSample\TypeQuery;
...
class TypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelSample.Map.TypeTableMap';
     ...
     */
    const OM_CLASS = '\\PropelSample\\Type';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelSample.Type';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelSample\\Type');
    ...
    {
        $this->addRelation('Customer', '\\PropelSample\\Customer', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':type_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelSample\Type) { // it's a model object
