...
use PropelSample\Payment;
use PropelSample\PaymentQuery;
...
class PaymentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelSample.Map.PaymentTableMap';
     ...
     */
    const OM_CLASS = '\\PropelSample\\Payment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelSample.Payment';
     ...
     */
    const COL_IDENTIFIER = 'payment.identifier';

    /**
     * the column name for the bank_name field
     */
    const COL_BANK_NAME = 'payment.bank_name';
     ...
     */
    const COL_DETAILS = 'payment.details';

    /**
     * the column name for the contract_id field
     */
    const COL_CONTRACT_ID = 'payment.contract_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Identifier', 'BankName', 'Amount', 'Details', 'ContractId', ),
        self::TYPE_CAMELNAME     => array('id', 'identifier', 'bankName', 'amount', 'details', 'contractId', ),
        self::TYPE_COLNAME       => array(PaymentTableMap::COL_ID, PaymentTableMap::COL_IDENTIFIER, PaymentTableMap::COL_BANK_NAME, PaymentTableMap::COL_AMOUNT, PaymentTableMap::COL_DETAILS, PaymentTableMap::COL_CONTRACT_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'identifier', 'bank_name', 'amount', 'details', 'contract_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Identifier' => 1, 'BankName' => 2, 'Amount' => 3, 'Details' => 4, 'ContractId' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'identifier' => 1, 'bankName' => 2, 'amount' => 3, 'details' => 4, 'contractId' => 5, ),
        self::TYPE_COLNAME       => array(PaymentTableMap::COL_ID => 0, PaymentTableMap::COL_IDENTIFIER => 1, PaymentTableMap::COL_BANK_NAME => 2, PaymentTableMap::COL_AMOUNT => 3, PaymentTableMap::COL_DETAILS => 4, PaymentTableMap::COL_CONTRACT_ID => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'identifier' => 1, 'bank_name' => 2, 'amount' => 3, 'details' => 4, 'contract_id' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelSample\\Payment');
        $this->setPackage('PropelSample');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('identifier', 'Identifier', 'VARCHAR', true, 30, '');
        $this->addColumn('bank_name', 'BankName', 'VARCHAR', true, 255, '');
        $this->addColumn('amount', 'Amount', 'BIGINT', true, null, null);
        $this->addColumn('details', 'Details', 'VARCHAR', true, null, null);
    ...
    {
        $this->addRelation('Contract', '\\PropelSample\\Contract', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':contract_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PaymentTableMap::COL_IDENTIFIER);
            $criteria->addSelectColumn(PaymentTableMap::COL_BANK_NAME);
            $criteria->addSelectColumn(PaymentTableMap::COL_AMOUNT);
            $criteria->addSelectColumn(PaymentTableMap::COL_DETAILS);
            $criteria->addSelectColumn(PaymentTableMap::COL_CONTRACT_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelSample\Payment) { // it's a model object
