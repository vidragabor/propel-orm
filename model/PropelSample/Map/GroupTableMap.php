...
use PropelSample\Group;
use PropelSample\GroupQuery;
...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelSample.Map.GroupTableMap';
     ...
     */
    const OM_CLASS = '\\PropelSample\\Group';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelSample.Group';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID, GroupTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID => 0, GroupTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelSample\\Group');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelSample\Group) { // it's a model object
